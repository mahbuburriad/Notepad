...
interface MenuConstants
{
    ...
    final String aboutText=
            "<html><big>notepad</big><hr><hr>"
                    +"<p align=right>Made By Mahbubur Riad. "
                    +"<strong>Thanks for using Notepad. </strong><br>"
                    +"Your Comments as well as bug reports r very welcome at<p align=center>"
                    +"<hr><em><big>mahbubur.riad@gmail.com</big></em><hr><html>";
}